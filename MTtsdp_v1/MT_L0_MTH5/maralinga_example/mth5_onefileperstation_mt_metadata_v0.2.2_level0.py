...
work_dir = '/scratch/abc/abc123/.../02_workspace/merged_data_maralinga'  ### Directory with L0 merged per run ASCII files
mth5_output_directory = '/scratch/abc/abc123/.../02_workspace/mth5_L0_outdir'
full_path_to_mth5_files = sorted(glob.glob(mth5_output_directory+"/*")) 
full_path_to_ascii_files = sorted(glob.glob(work_dir+"/*"))
mt_metadata_dir = '/scratch/abc/abc123/.../mt_metadata_excel_spreadsheet/station_json_outdir/export' ### Directory with exported JSON files
