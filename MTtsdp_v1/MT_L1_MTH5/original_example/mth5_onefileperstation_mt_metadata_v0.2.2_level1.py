...
stations_single_run = ['SA225-2','SA227',   'SA242',  'SA243',  'SA245',
                ...
                'WA75',   'WANT19',  'WANT38', 'WANT45',  
                'WASA327','WASA302']                          ### 41 single run WA stations 
                                   

stations_multiple_runs = ['SA246','SA299','SA324-2']
...
def channel_data_extraction_rotation_downsampling_unit_conversion(mth5_file,station,run,resampling_rate):
    ...
    ex_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations/'+station+'/'+run+'/'+'ex'
    ey_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations/'+station+'/'+run+'/'+'ey'
    bx_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations/'+station+'/'+run+'/'+'bx'
    by_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations/'+station+'/'+run+'/'+'by'
    bz_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations/'+station+'/'+run+'/'+'bz'
    ...
    translated_azimuth_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations/' + station + '/' + run + '/' + 'bx'
...
def create_mth5_group_station_run_channel_multiple_runs(mth5_file,station,resampling_rate_hz,mt_metadata):
    ...
    station_string = 'Experiment/Surveys/AusLAMP_Musgraves/Stations' + '/' + station
    groups = []
