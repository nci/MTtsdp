...
excel_spreadsheet = f'/g/data/<xy12>/<abc123>/supplementing_files/mt_metadata_v0.2.2_excel/{survey_spreadsheet}'
station_json_from_spreadsheet_directory = f'/g/data/<xy12>/<abc123>/supplementing_files/json_metadata/{survey}/import/'
json_export_directory = f'/g/data/<xy12>/<abc123>/supplementing_files/json_metadata/{survey}/export/'
base_json_file = '/g/data/<xy12>/<abc123>/used_scripts/MT_L0_MTH5/AusLAMP_SA/base_v0.2.1.json'
