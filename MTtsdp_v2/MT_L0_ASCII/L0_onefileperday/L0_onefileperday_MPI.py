...
survey_name = 'NE_SA_survey'# SUCCESS

product = 'Concatenated_Time_Series_ASCII_per_day'
data_location = '/g/data/<xy12>/<abc123>/raw_data/EDL/'+survey_name ###
outdir = '/g/data/<xy12>/<abc123>/processed_data/' ### 

############################################################################
# Values FIXED for the SA MT Data Collection
...
out_location = path.join(outdir, state, survey_name, level, product)

print("Creating product " + product)
print("Survey name: " + survey_name)
print("Data location: " + data_location)

print("Data will be saved under: " + out_location)
