...
# Out folder
survey = "Maralinga_Far_West_Coast_survey_LEMI"
level = 'level_0'
...
# Add all sites here that 01_check finds to be problematic!
if __name__ == "__main__":
    ...
    sta_exclude_set = set( (
        'SA28_2B','SA29_2A','SA33_2A','SA33_2B','SA38_2A','SA38_2B','SA46_2A','SA46_2B',
        'SA50_2A','SA50_2B','SA53_2A','SA53_2B','SA29_2B'#,'SA33_2A'# warnings reported by 01_check.py, added in SAXXX as python set needs at least 2 elements.
    ) )
