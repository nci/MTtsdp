...
# Check if survey spreadsheet and survey are provided
if len(sys.argv) < 3:
    print("Usage: python your_script.py <survey_name>")
    sys.exit(1)

survey_spreadsheet = sys.argv[1]
survey = sys.argv[2]

excel_spreadsheet = f'/g/data/xr05/nre900/supplementing_files/mt_metadata_v0.2.2_downsampled_excel/{survey_spreadsheet}'
station_json_from_spreadsheet_directory = f'/g/data/xr05/nre900/supplementing_files/json_metadata_downsampled/{survey}/import/'
json_export_directory = f'/g/data/xr05/nre900/supplementing_files/json_metadata_downsampled/{survey}/export/'
base_json_file = '/g/data/xr05/nre900/used_scripts/MT_L1_MTH5/AusLAMP_SA/base_v0.2.1.json'
